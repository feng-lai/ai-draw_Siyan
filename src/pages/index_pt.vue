  ...
  <div class="app">
    ...
    <nav class="navbar">
      ...
      <div class="navbar-right">
        <a href="#" class="nav-link" @click="showLoginModal = true">Entrar</a>
        <button class="btn-primary">Começart for Free</button>
      </div>
    ...
    <div class="mobile-menu" :class="{ 'open': mobileMenuOpen }">
      ...
      <a href="#" class="mobile-link" @click="showLoginModal = true">Entrar</a>
      <button class="btn-primary mobile-btn">Começart for Free</button>
    </div>
    ...
    <section id="pricing" class="pricing">
      <h2 class="section-title">Simple, Transparent Preços</h2>
      ...
      <div class="pricing-grid">
        <div class="pricing-card">
          ...
          <button class="btn-secondary">Get Começarted</button>
        </div>
        ...
        <div class="pricing-card featured">
          ...
          <button class="btn-primary">Get Começarted</button>
        </div>
          ...
          <div class="footer-links-section">
            <div class="footer-links-column">
              ...
              <ul class="footer-links">
                ...
                <li><a href="#">All Ferramentas</a></li>
              </ul>
            </div>
            ...
            <div class="footer-links-column">
              ...
              <ul class="footer-links">
                ...
                <li><a href="#">Fale com Vendas</a></li>
              </ul>
            </div>
