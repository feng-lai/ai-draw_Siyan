  ...
  <div class="app">
    ...
    <nav class="navbar">
      ...
      <div class="navbar-right">
        <a href="#" class="nav-link" @click="showLoginModal = true">Iniciar Sesión</a>
        <button class="btn-primary">Comenzart for Free</button>
      </div>
    ...
    <div class="mobile-menu" :class="{ 'open': mobileMenuOpen }">
      ...
      <a href="#" class="mobile-link" @click="showLoginModal = true">Iniciar Sesión</a>
      <button class="btn-primary mobile-btn">Comenzart for Free</button>
    </div>
    ...
    <section id="pricing" class="pricing">
      <h2 class="section-title">Simple, Transparent Precios</h2>
      ...
      <div class="pricing-grid">
        <div class="pricing-card">
          ...
          <button class="btn-secondary">Get Comenzarted</button>
        </div>
        ...
        <div class="pricing-card featured">
          ...
          <button class="btn-primary">Get Comenzarted</button>
        </div>
    ...
    <section class="cta">
      ...
      <button class="btn-primary btn-large">Comenzart Creating for Free</button>
    ...
    <div class="pre-footer">
      <div class="container">
        ...
        <button class="btn-primary btn-large">Comenzart for Free</button>
      </div>
    </div>
          ...
          <div class="footer-links-section">
            <div class="footer-links-column">
              ...
              <ul class="footer-links">
                ...
                <li><a href="#">All Herramientas</a></li>
              </ul>
            </div>
    ...
    <div class="login-modal" v-if="showLoginModal">
      <div class="modal-header">
        <h3 class="modal-title">Iniciar Sesión to siyan.ai</h3>
